...
{  	public enum AWMoveTypes { Walk = 0, Run=1 ,Crawl=2 };
	...
	[System.Serializable]
	public struct WaypointExtend
	{
		public AWMoveTypes MoveType;
		public AWPoseTypes PoseType;
		public int GrenadeAmount;
		public int FireAmount;
		public WaypointExtend(AWMoveTypes MoveType = AWMoveTypes.Walk, AWPoseTypes PoseType = AWPoseTypes.Stand, int GrenadeAmount=0,int FireAmount=0)
		{
    ...
    public class EmeraldMovement : MonoBehaviour
    {
	    ...
	    // advanced waypoints setting
	    public List<Vector3> WaypointsList = new List<Vector3>();
	    public List<WaypointExtend> WaypointExtendsList = new List<WaypointExtend>();
	    // advanced waypoints setting
	    ...
	    public enum WaypointTypes { Loop = 0, Reverse = 1, Random = 2 ,Advanced = 3};
