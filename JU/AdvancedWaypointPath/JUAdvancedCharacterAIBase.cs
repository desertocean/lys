...
namespace JU.CharacterSystem.AI
{
    ...
    /// </summary>
	public class JUProtectedCharacterAIBase : MonoBehaviour
    {
        /// <summary>
        /// Navigation modes
        /// </summary>
        ...
        /// </summary>
	    protected JUProtectedCharacterAIBase()
        {
            AimSpeed = 200;
            MoveEnabled = true;
        ...
        protected void UpdateCharacterLookAt()
        {
	    ...
	    protected virtual  void UpdateCharacterControls()
        {
