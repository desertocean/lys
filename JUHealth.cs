...
namespace JUTPS
{
    ...
    public class JUHealth : MonoBehaviour, IIsDead
    {
        ...
        public void DoDamage(float damage, bool invoke = true)
        {
            DoDamage(new DamageInfo { Damage = damage }, invoke);
        }
 
        public void DoDamage(DamageInfo damageInfo, bool invoke=true)
        {
